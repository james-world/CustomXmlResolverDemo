...
def upload_file(container_client: ContainerClient, source: str, dest: str) -> None:
    """
    Upload single file to a path inside the container.
    """
...
def init_containers(
        service_client: BlobServiceClient, containers_directory: str) -> None:
    """
    Iterate on the containers directory and do the following:
    1. Create the container.
    2. Upload all the folders and files to the container.
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=True,
        help="""
        Directory that contains subdirectories named after the containers
        that we should create. Each subdirectory will contain the files
